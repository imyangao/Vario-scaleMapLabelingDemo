(function () {
            ...
            switch (words[0])
            {
                ...
                case 'g': {
                    ...
                    if (fcolor === undefined) 
                    {
                        ...
                        fcolor = { r_frac: 213/255, g_frac: 240/255, b_frac: 205/255 };
                    }
                    break
                }
    ...
    function generate_class_color() {
        var class_color_raw_dt = {
            ...
            // road - regional road
            '10400': [185, 201, 199],   //check
            '10401': [185, 201, 199],   //check
            '10402': [185, 201, 199],   //check
            '10410': [185, 201, 199],   //check
            '10411': [185, 201, 199],   //check
            '10412': [185, 201, 199],   //check
            ...
            // road: half paved
            '10720': [185, 201, 199],   //check
            '10721': [185, 201, 199],   //check
            '10722': [185, 201, 199],   //check
